...
abstract class AppLocalizations {
  ...
  /// No description provided for @acceptInfoAngelman.
  ///
  /// In en, this message translates to:
  /// **'I agree to receive information about Angelman syndrome'**
  String get acceptInfoAngelman;

  /// No description provided for @signupEnableGeolocation.
  ///
  /// In en, this message translates to:
...
class _AppLocalizationsDelegate extends LocalizationsDelegate<AppLocalizations> {
  ...
  @override
  bool isSupported(Locale locale) => <String>['de', 'en', 'es', 'fr', 'id', 'it', 'pl', 'pt'].contains(locale.languageCode);
