...
class AppLocalizationsDe extends AppLocalizations {
  ...
  @override
  String get consentText => 'Datenschutzerklärung – ASConnect Anwendung\n\n1) Identität des Verantwortlichen\nDie in der ASConnect-Anwendung erhobenen Daten werden von AngelmanAnalytics als Verantwortlicher verarbeitet.\nBei Fragen zu Ihren Daten oder zur Ausübung Ihrer Rechte können Sie uns unter folgender Adresse kontaktieren: contact@angelmananalytics.org.\n____________________________________________\n2) Zwecke der Verarbeitung\nDie über die Anwendung durchgeführten Datenverarbeitungen verfolgen folgende Zwecke:\no Erstellung und Verwaltung Ihres Benutzerkontos für einen namentlichen Zugang zur ASConnect-Anwendung;\no Nutzung von Geolokalisierungsfunktionen zur Anzeige von:\no Profilen betroffener Personen nach verschiedenen Kriterien (geografische Entfernung, Genotyp, Altersgruppe);\no Verbesserung des Dienstes und Personalisierung der Benutzererfahrung, einschließlich der Möglichkeit für den Benutzer.\no Extraktion von Daten, die keine Identifizierung von Personen ermöglichen, zu statistischen Zwecken: Anzahl der Personen mit Angelman-Syndrom, Altersverteilung...\n____________________________________________\n3) Kategorien der erhobenen Daten\nFolgende Daten können erhoben werden:\n• Identifikationsdaten:\no Geschlecht, Nachname, Vorname, E-Mail-Adresse, Passwort, Foto,\no Sicherheitsfrage und -antwort (bei vergessenem Passwort);\n• Sensible Daten:\no Genotyp, Standort.\nRechtsgrundlage für diese Verarbeitung ist die ausdrückliche und informierte Einwilligung des Nutzers.\n____________________________________________\n4) Speicherdauer der Daten\nDie Daten werden während der gesamten Nutzungsdauer des Kontos gespeichert und spätestens 12 Monate nach der letzten Aktivität gelöscht.\nDer Nutzer kann jederzeit sein Recht auf Löschung direkt in der Anwendung über das Menü ausüben:\nDatenschutzerklärung → Recht auf Löschung.\n____________________________________________\n5) Empfänger und Hosting der Daten\nDie Daten werden sicher auf den Servern von PythonAnywhere gespeichert.\nDie Daten werden innerhalb der Europäischen Union gespeichert.\n(Für weitere Informationen zur Datenschutzrichtlinie des Hosting-Anbieters siehe https://www.pythonanywhere.com/privacy/.)\nDie Webanwendung wird bei O2Switch in Frankreich gehostet, siehe https://www.o2switch.fr/du-rgpd.pdf.\n____________________________________________\n6) Rechte der Nutzer\nGemäß der Verordnung (EU) 2016/679 (DSGVO) haben die Nutzer folgende Rechte:\no Recht auf Auskunft, Berichtigung und Löschung („Recht auf Vergessenwerden“) — direkt über ihr Profil oder das Menü Datenschutzerklärung → Recht auf Löschung;\no Recht auf Widerspruch, Datenübertragbarkeit und Einschränkung der Verarbeitung;\no Recht auf Widerruf der Einwilligung jederzeit.\nZur Ausübung dieser Rechte (außer dem in der Anwendung verfügbaren Recht auf Löschung) können Sie eine E-Mail an contact@angelmananalytics.org senden.\n____________________________________________\n7) Sicherheit und Vertraulichkeit\nAlle Daten werden bei der Speicherung und Übertragung verschlüsselt.\nPasswörter werden gemäß bewährten Sicherheitspraktiken gehasht, und die gesamte Kommunikation mit dem Dienst erfolgt über das HTTPS-Protokoll.\n____________________________________________\n8) Ausdrückliche Einwilligung\nDie Registrierung in der ASConnect-Anwendung erfordert die ausdrückliche und informierte Einwilligung des Nutzers für die in Abschnitt 2 beschriebenen Verarbeitungen.\nDer Nutzer kann diese Einwilligung jederzeit über die Kontoeinstellungen oder durch direkten Kontakt unter contact@angelmananalytics.org widerrufen.\n____________________________________________\n9) Regeln für die ordnungsgemäße Nutzung ausgetauschter Nachrichten\no Veröffentlichen Sie keine Angriffe oder negativen Kommentare über Gruppen.\no Seien Sie freundlich und respektvoll.\no Keine respektlosen Kommentare.\no Die Weitergabe von Ratschlägen darf nicht als medizinische Empfehlung verstanden werden.\no Keine Werbung.\no Die Nichteinhaltung der Regeln kann zur Löschung des Profils durch den Administrator führen.';
  ...
  @override
  String get mapLocationResolverMissing => 'Standort ist nicht verfügbar.';

  @override
  String get mapLocationUnableToGet => 'Standort konnte nicht abgerufen werden. Prüfe GPS und Berechtigungen.';

  @override
  String get groupDeleteTitle => 'Gruppe löschen?';

  @override
  String get groupDeleteBody => 'Dadurch wird die Gruppenkonversation dauerhaft für alle Mitglieder gelöscht.';

  @override
  String get groupDeleteConfirm => 'Löschen';

  @override
  String get editProfilePhotoConverting => 'Wird konvertiert…';

  @override
  String get mapLanguagesSectionTitle => 'Sprachen';

  @override
  String get mapAllLanguagesSelected => 'Alle Sprachen';
