...
class AppLocalizationsEs extends AppLocalizations {
  ...
  @override
  String get signupEmailAlreadyExistsRedirect => 'Tu correo ya está en nuestra base de datos! Introduce otra dirección de correo electrónico o ve a la sección “Olvidé mi contraseña”.';
  ...
  @override
  String get tooManyAttemptsMessage => 'Has superado el número de intentos.\n\nEscribe a contact@angelmananalytics.org para explicar tu problema de inicio de sesión.';
  ...
  @override
  String get versionMadeByFastFrance => 'Esta aplicación ha sido desarrollada por Angelman Analytics (www.angelmananalytics.org)';
  ...
  @override
  String get consentText => 'Política de Privacidad – Aplicación ASConnect\n\n1) Identidad del Responsable del Tratamiento\nLos datos recopilados en la aplicación ASConnect son tratados por AngelmanAnalytics como responsable del tratamiento.\nPara cualquier pregunta relacionada con sus datos o el ejercicio de sus derechos, puede contactarnos en: contact@angelmananalytics.org.\n____________________________________________\n2) Finalidades del Tratamiento\nLos tratamientos de datos realizados a través de la aplicación tienen las siguientes finalidades:\no Creación y gestión de su cuenta de usuario para un acceso nominativo a la aplicación ASConnect;\no Uso de funcionalidades de geolocalización para visualizar:\no Perfiles de personas afectadas según diferentes criterios (distancia geográfica, genotipo, rango de edad);\no Mejora del servicio y personalización de la experiencia del usuario, incluyendo la posibilidad para el usuario.\no Extracción de datos que no permiten identificar a personas con fines estadísticos: número de personas con síndrome de Angelman, distribución por edad...\n____________________________________________\n3) Categorías de Datos Recopilados\nSe pueden recopilar los siguientes datos:\n• Datos de identificación:\no sexo, apellido, nombre, correo electrónico, contraseña, foto,\no pregunta y respuesta secreta (en caso de olvido de contraseña);\n• Datos sensibles:\no genotipo, localización.\nLa base legal de este tratamiento es el consentimiento explícito e informado del usuario.\n____________________________________________\n4) Plazo de Conservación\nLos datos se conservan durante el uso de la cuenta y se eliminan en un plazo máximo de 12 meses tras la última actividad.\nEl usuario puede ejercer en cualquier momento su derecho de supresión directamente desde la aplicación a través del menú:\nPolítica de Privacidad → Derecho de supresión.\n____________________________________________\n5) Destinatarios y Alojamiento\nLos datos se alojan de forma segura en los servidores de PythonAnywhere.\nLos datos se almacenan dentro de la Unión Europea.\n(Para más información sobre la política de protección de datos del proveedor, consulte https://www.pythonanywhere.com/privacy/.)\nLa aplicación web está alojada en O2Switch en Francia, consulte https://www.o2switch.fr/du-rgpd.pdf.\n____________________________________________\n6) Derechos de los Usuarios\nde acuerdo con el Reglamento (UE) 2016/679 (RGPD), los usuarios tienen los siguientes derechos:\no Derecho de acceso, rectificación y supresión («derecho al olvido») — directamente a través de su perfil o del menú Política de Privacidad → Derecho de supresión;\no Derecho de oposición, portabilidad y limitación del tratamiento;\no Derecho a retirar el consentimiento en cualquier momento.\nPara ejercer estos derechos (excepto el derecho de supresión accesible desde la aplicación), puede enviar un correo electrónico a contact@angelmananalytics.org.\n____________________________________________\n7) Seguridad y Confidencialidad\nTodos los datos están cifrados durante el almacenamiento y la transmisión.\nLas contraseñas se almacenan con hash según buenas prácticas de seguridad y todas las comunicaciones se realizan mediante HTTPS.\n____________________________________________\n8) Consentimiento Explícito\nEl registro en la aplicación ASConnect requiere el consentimiento explícito e informado del usuario para los tratamientos descritos en la sección 2.\nEl usuario puede retirar este consentimiento en cualquier momento desde la configuración de la cuenta o contactando a contact@angelmananalytics.org.\n____________________________________________\n9) Normas de Buen Uso\no No publique ataques o comentarios negativos sobre grupos.\no Sea amable y respetuoso.\no No comentarios irrespetuosos.\no Los consejos compartidos no deben considerarse recomendaciones médicas.\no No publicidad.\no El incumplimiento puede llevar a la eliminación del perfil.';
  ...
  @override
  String get mapConnectionSectionTitle => 'Conexión';

  @override
  String get mapConnectedOnlyLabel => 'Mostrar solo personas conectadas';

  @override
  String get mapConnectedOnlyHint => 'Oculta los perfiles sin conexión.';
  ...
  @override
  String get acceptInfoAngelman => 'Acepto recibir información sobre el síndrome de Angelman';

  @override
  String get signupEnableGeolocation => 'Por favor, autoriza la geolocalización para continuar.';

  @override
  String get signUpCheckMail => 'Verificación del correo';

  @override
  String get signUpGPS => 'Determinación de las coordenadas de tu ciudad a partir de la ubicación GPS';

  @override
  String get signUpMessageCreate => 'Creación del perfil';
  ...
  @override
  String get groupCreateTooltip => 'Crear un grupo';

  @override
  String get groupCreateTitle => 'Crear un grupo';

  @override
  String get groupCreateIntro => 'Estás a punto de crear un grupo. Elige un título significativo, escribe el primer mensaje y define la audiencia mediante los filtros.';

  @override
  String get groupTitleLabel => 'Título del grupo';

  @override
  String get groupFirstMessageLabel => 'Primer mensaje';

  @override
  String get groupCreateButton => 'Crear';

  @override
  String get groupTitleRequired => 'El título es obligatorio';

  @override
  String get groupCreateNoMembers => 'No se puede crear un grupo sin miembros';
  ...
  @override
  String get loadingGroup => 'Cargando...';

  @override
  String get mapLocationResolverMissing => 'La ubicación no está disponible.';

  @override
  String get mapLocationUnableToGet => 'No se pudo obtener la ubicación. Verifica el GPS y los permisos.';

  @override
  String get groupDeleteTitle => '¿Eliminar el grupo?';

  @override
  String get groupDeleteBody => 'Esto eliminará permanentemente la conversación del grupo para todos los miembros.';

  @override
  String get groupDeleteConfirm => 'Eliminar';

  @override
  String get editProfilePhotoConverting => 'Convirtiendo…';

  @override
  String get mapLanguagesSectionTitle => 'Idiomas';

  @override
  String get mapAllLanguagesSelected => 'Todos los idiomas';
