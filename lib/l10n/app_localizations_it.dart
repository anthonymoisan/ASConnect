...
class AppLocalizationsIt extends AppLocalizations {
  ...
  @override
  String get consentText => 'Informativa sulla Privacy – Applicazione ASConnect\n\n1) Identità del Titolare del Trattamento\nI dati raccolti nell’applicazione ASConnect sono trattati da AngelmanAnalytics in qualità di titolare del trattamento.\nPer qualsiasi domanda relativa ai vostri dati o all’esercizio dei vostri diritti, potete contattarci a: contact@angelmananalytics.org.\n____________________________________________\n2) Finalità del Trattamento\nI trattamenti di dati effettuati tramite l’applicazione perseguono le seguenti finalità:\no Creazione e gestione del vostro account utente per un accesso nominativo all’applicazione ASConnect;\no Utilizzo delle funzionalità di geolocalizzazione per visualizzare:\no Profili di persone interessate, secondo diversi criteri (distanza geografica, genotipo, fascia d’età);\no Miglioramento del servizio e personalizzazione dell’esperienza utente, inclusa la possibilità per l’utente.\no Estrazione di dati che non consentono l’identificazione delle persone a fini statistici: numero di persone affette da sindrome di Angelman, distribuzione per età...\n____________________________________________\n3) Categorie di Dati Raccolti\nPossono essere raccolti i seguenti dati:\n• Dati identificativi:\no sesso, cognome, nome, indirizzo e-mail, password, foto,\no domanda e risposta segreta (in caso di dimenticanza della password);\n• Dati sensibili:\no genotipo, localizzazione.\nLa base giuridica di tali trattamenti è il consenso esplicito e informato dell’utente.\n____________________________________________\n4) Periodo di Conservazione dei Dati\nI dati sono conservati per tutta la durata di utilizzo dell’account e successivamente cancellati entro un massimo di 12 mesi dall’ultima attività.\nL’utente può in qualsiasi momento esercitare il diritto all’oblio direttamente nell’applicazione tramite il menu:\nInformativa sulla Privacy → Diritto all’oblio.\n____________________________________________\n5) Destinatari e Hosting dei Dati\nI dati sono ospitati in modo sicuro sui server di PythonAnywhere.\nI dati sono conservati nell’Unione Europea.\n(Per maggiori informazioni sulla politica di protezione dei dati dell’hosting, consultare https://www.pythonanywhere.com/privacy/.)\nL’applicazione Web è ospitata presso O2Switch in Francia, consultare https://www.o2switch.fr/du-rgpd.pdf.\n____________________________________________\n6) Diritti degli Utenti\nConformemente al Regolamento (UE) 2016/679 (GDPR), gli utenti dispongono dei seguenti diritti:\no Diritto di accesso, rettifica e cancellazione («diritto all’oblio») — direttamente tramite il proprio profilo o il menu Informativa sulla Privacy → Diritto all’oblio;\no Diritto di opposizione, portabilità e limitazione del trattamento;\no Diritto di revocare il consenso in qualsiasi momento.\nPer esercitare tali diritti (diversi dal diritto all’oblio accessibile dall’applicazione), è possibile inviare un’e-mail a contact@angelmananalytics.org.\n____________________________________________\n7) Sicurezza e Riservatezza\nTutti i dati sono cifrati durante l’archiviazione e la trasmissione.\nLe password sono memorizzate con hash secondo le buone pratiche di sicurezza e tutte le comunicazioni avvengono tramite protocollo HTTPS.\n____________________________________________\n8) Consenso Esplicito\nLa registrazione all’applicazione ASConnect richiede il consenso esplicito e informato dell’utente per i trattamenti descritti nella sezione 2.\nL’utente può revocare tale consenso in qualsiasi momento tramite le impostazioni dell’account o contattando direttamente contact@angelmananalytics.org.\n____________________________________________\n9) Regole di Buon Uso dei Messaggi Scambiati\no Non pubblicare attacchi o commenti negativi riguardanti gruppi.\no Sii gentile e cortese.\no Nessun commento irrispettoso.\no La trasmissione di consigli non deve essere considerata come raccomandazioni mediche.\no Nessuna pubblicità.\no Il mancato rispetto delle regole può comportare la cancellazione del profilo da parte dell’amministratore.';
  ...
  @override
  String get groupCreateTooltip => 'Crea un gruppo';

  @override
  String get groupCreateTitle => 'Crea un gruppo';

  @override
  String get groupCreateIntro => 'Stai per creare un gruppo. Scegli un titolo significativo, scrivi il primo messaggio e definisci il pubblico tramite i filtri.';

  @override
  String get groupTitleLabel => 'Titolo del gruppo';

  @override
  String get groupFirstMessageLabel => 'Primo messaggio';

  @override
  String get groupCreateButton => 'Crea';

  @override
  String get groupTitleRequired => 'Il titolo è obbligatorio';

  @override
  String get groupCreateNoMembers => 'Impossibile creare un gruppo senza membri';
  ...
  @override
  String get groupDeleteTitle => 'Eliminare il gruppo?';

  @override
  String get groupDeleteBody => 'Questa azione eliminerà definitivamente la conversazione di gruppo per tutti i membri.';

  @override
  String get groupDeleteConfirm => 'Elimina';
