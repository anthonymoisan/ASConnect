...
class AppLocalizationsPl extends AppLocalizations {
  ...
  @override
  String get versionMadeByFastFrance => 'Ta aplikacja została opracowana przez FAST France';
  ...
  @override
  String get consentText => 'Polityka prywatności – aplikacja ASConnect\n\n1) Administrator danych\nDane zebrane w aplikacji ASConnect są przetwarzane przez FAST France jako administratora danych.\nJeśli masz pytania dotyczące Twoich danych lub sposobu wykonywania Twoich praw, skontaktuj się z nami: contact@fastfrance.org.\n\n2) Cele przetwarzania\nPrzetwarzanie danych realizowane za pośrednictwem aplikacji służy następującym celom:\n• Tworzenie i zarządzanie Twoim kontem użytkownika w celu uzyskania dostępu do aplikacji ASConnect;\n• Korzystanie z funkcji geolokalizacji w celu wyświetlania:\n  o punktów zainteresowania związanych z zespołem Angelmana,\n  o i/lub profili osób, według różnych kryteriów (odległość geograficzna, genotyp, przedział wiekowy);\n• Ulepszanie usługi i personalizacja doświadczenia użytkownika, w tym umożliwienie użytkownikom wyboru, czy wyświetlać zdjęcie, imię lub nazwisko.\n\n3) Kategorie zbieranych danych\nMogą być zbierane następujące dane:\n• Dane identyfikacyjne:\n  o nazwisko, imię, adres e-mail, hasło, zdjęcie,\n  o pytanie i odpowiedź zabezpieczające (w przypadku zapomnianego hasła);\n• Dane wrażliwe:\n  o genotyp, lokalizacja telefonu (geolokalizacja).\nPodstawą prawną tego przetwarzania jest wyraźna i świadoma zgoda użytkownika.\n\n4) Okres przechowywania danych\nDane są przechowywane przez okres korzystania z konta, a następnie usuwane maksymalnie w ciągu 12 miesięcy od ostatniej aktywności.\nUżytkownicy mogą skorzystać z prawa do bycia zapomnianym w dowolnym momencie bezpośrednio w aplikacji:\nPolityka prywatności → Prawo do bycia zapomnianym.\n\n5) Odbiorcy danych i hosting\nDane są bezpiecznie hostowane na serwerach PythonAnywhere.\nDane są przechowywane w Unii Europejskiej.\n(Więcej informacji w polityce prywatności hosta: https://www.pythonanywhere.com/privacy/.)\n\n6) Prawa użytkowników\nZgodnie z Rozporządzeniem (UE) 2016/679 (RODO), użytkownikom przysługują następujące prawa:\n• Prawo dostępu, sprostowania i usunięcia („prawo do bycia zapomnianym”) — bezpośrednio przez profil lub przez Polityka prywatności → Prawo do bycia zapomnianym;\n• Prawo sprzeciwu, przenoszenia danych i ograniczenia przetwarzania;\n• Prawo do wycofania zgody w dowolnym momencie.\nAby skorzystać z tych praw (poza prawem do bycia zapomnianym w aplikacji), wyślij e-mail: contact@fastfrance.org.\n\n7) Bezpieczeństwo i poufność\nWszystkie dane są szyfrowane podczas przechowywania i transmisji.\nHasła są haszowane zgodnie z najlepszymi praktykami bezpieczeństwa, a cała komunikacja z usługą odbywa się przez HTTPS.\n\n8) Wyraźna zgoda\nRejestracja w aplikacji ASConnect wymaga wyraźnej i świadomej zgody użytkownika na przetwarzanie opisane w punkcie 2.\nUżytkownicy mogą wycofać zgodę w dowolnym momencie w ustawieniach konta lub kontaktując się z contact@fastfrance.org.';
