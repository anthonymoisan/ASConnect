...
class AppLocalizationsPl extends AppLocalizations {
  ...
  @override
  String get consentText => 'Polityka prywatności – Aplikacja ASConnect\n\n1) Tożsamość administratora danych\nDane gromadzone w aplikacji ASConnect są przetwarzane przez AngelmanAnalytics, działającą jako administrator danych.\nW przypadku pytań dotyczących Państwa danych osobowych lub realizacji przysługujących praw, prosimy o kontakt pod adresem: contact@angelmananalytics.org.\n\n____________________________________________\n2) Cele przetwarzania danych\nPrzetwarzanie danych realizowane za pośrednictwem aplikacji służy następującym celom:\n• Utworzenie i zarządzanie kontem użytkownika umożliwiającym imienny dostęp do aplikacji ASConnect;\n• Korzystanie z funkcji geolokalizacji w celu wyświetlania:\n  o profili osób objętych aplikacją, według różnych kryteriów (odległość geograficzna, genotyp, przedział wiekowy);\n  o poprawy jakości usług oraz personalizacji doświadczenia użytkownika;\n• Analiza danych statystycznych, które nie umożliwiają identyfikacji osób, w szczególności: liczby osób dotkniętych zespołem Angelmana, rozkładu według wieku itp.\n\n____________________________________________\n3) Kategorie gromadzonych danych\nMogą być gromadzone następujące dane:\n• Dane identyfikacyjne:\n  o nazwisko, imię, adres e-mail, hasło, zdjęcie,\n  o pytanie i odpowiedź zabezpieczająca (w przypadku zapomnienia hasła);\n• Dane wrażliwe:\n  o genotyp, lokalizacja.\nPodstawą prawną przetwarzania tych danych jest wyraźna i świadoma zgoda użytkownika.\n\n____________________________________________\n4) Okres przechowywania danych\nDane są przechowywane przez cały okres korzystania z konta, a następnie usuwane najpóźniej w ciągu 12 miesięcy od ostatniej aktywności użytkownika.\nUżytkownik może w każdej chwili skorzystać z prawa do bycia zapomnianym bezpośrednio w aplikacji, poprzez menu:\nPolityka prywatności → Prawo do bycia zapomnianym.\n\n____________________________________________\n5) Odbiorcy danych i hosting\nDane są bezpiecznie przechowywane na serwerach PythonAnywhere.\nDane są przechowywane na terytorium Unii Europejskiej.\n(Więcej informacji na temat polityki ochrony danych dostawcy hostingu można znaleźć na stronie: https://www.pythonanywhere.com/privacy/).\n\n____________________________________________\n6) Prawa użytkowników\nZgodnie z Rozporządzeniem (UE) 2016/679 (RODO), użytkownikom przysługują następujące prawa:\n• Prawo dostępu do danych, ich sprostowania oraz usunięcia („prawo do bycia zapomnianym”) — bezpośrednio poprzez profil użytkownika lub menu Polityka prywatności → Prawo do bycia zapomnianym;\n• Prawo sprzeciwu wobec przetwarzania danych, prawo do przenoszenia danych oraz prawo do ograniczenia przetwarzania;\n• Prawo do cofnięcia zgody w dowolnym momencie.\nW celu skorzystania z tych praw (innych niż prawo do bycia zapomnianym dostępne w aplikacji), prosimy o kontakt e-mailowy: contact@angelmananalytics.org.\n\n____________________________________________\n7) Bezpieczeństwo i poufność\nWszystkie dane są szyfrowane podczas przechowywania i transmisji.\nHasła są przechowywane w postaci zaszyfrowanych skrótów zgodnie z najlepszymi praktykami bezpieczeństwa, a cała komunikacja z usługą odbywa się za pośrednictwem protokołu HTTPS.\n\n____________________________________________\n8) Wyraźna zgoda\nRejestracja w aplikacji ASConnect wymaga wyraźnej i świadomej zgody użytkownika na przetwarzanie danych opisane w punkcie 2.\nUżytkownik może w każdej chwili wycofać tę zgodę poprzez ustawienia konta lub kontaktując się bezpośrednio pod adresem contact@angelmananalytics.org.';
